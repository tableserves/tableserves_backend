...
const tableServeRatingSchema = new Schema({
  ...
  categories: {
    food: {
      ...
      feedback: {
        type: String,
        maxlength: [500, 'Food feedback cannot exceed 500 characters'],
        trim: true
      }
    },
    ...
    venue: {
      ...
      feedback: {
        type: String,
        maxlength: [500, 'Venue feedback cannot exceed 500 characters'],
        trim: true
      }
    },
    ...
    platform: {
      rating: {
        type: Number,
        min: [1, 'Platform rating must be between 1 and 5'],
        max: [5, 'Platform rating must be between 1 and 5']
      },
      feedback: {
        type: String,
        maxlength: [500, 'Platform feedback cannot exceed 500 characters'],
        trim: true
      }
    },
...
tableServeRatingSchema.virtual('averageCategoryRating').get(function() {
  ...
  const ratings = [
    categories.food?.rating,
    categories.venue?.rating,
    categories.platform?.rating,
