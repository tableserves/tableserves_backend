...
const subscriptionSchema = new Schema({
  ...
  planKey: {
    ...
    enum: {
      values: [
        // Restaurant Plans
        'restaurant_starter', 'restaurant_professional', 'restaurant_enterprise',
        // Zone Plans  
        'zone_basic', 'zone_professional', 'zone_enterprise',
        // Admin Plans
        'admin_platform'
      ],
  ...
  limits: {
    ...
    maxShops: {
      type: Number,
      default: 5,
      min: [1, 'Must have at least 1 shop'],
    ...
    maxVendors: {
      type: Number,
      default: 10,
      min: [1, 'Must have at least 1 vendor'],
    ...
    maxMenuItems: {
      type: Number,
      default: 100,
      min: [1, 'Must have at least 1 menu item'],
