...
import { sanitizeInput } from '../../../shared/utils/inputSanitizer';
            ...
            {filteredVendors.length === 0 ? (
              ...
              filteredVendors.map((vendor) => (
                <motion.div
                  ...
                  className="admin-card rounded-xl border border-theme-border shadow-sm hover:shadow-md hover:border-theme-accent-primary/40 transition-all duration-300 flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 gap-4 bg-theme-bg-primary"
                >
                  {/* Left Side: Icon & Main Details */}
                  <div className="flex items-center gap-4 flex-1 min-w-0 w-full sm:w-auto">
                    <div className="w-12 h-12 shrink-0 bg-theme-accent-primary/10 rounded-lg flex items-center justify-center border border-theme-accent-primary/20">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-theme-text-secondary text-xs font-raleway truncate flex items-center gap-1.5">
                        {vendor.cuisine && (
                          <span className="capitalize font-medium text-theme-text-primary/70">
                            {vendor.cuisine.replace(/_/g, ' ')}
                          </span>
                        )}
                        {vendor.cuisine && vendor.description && <span>•</span>}
                        {vendor.description && (
                  ...
                  {/* Middle/Right: Owner Details & Actions */}
                  <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-t-0 border-theme-border/50">
                    
                    {/* Owner Info */}
                    <div className="flex flex-col gap-1 md:flex shrink-0 min-w-[140px]">
                      <div className="flex items-center gap-2">
                        <FaUser className="text-theme-text-tertiary text-[10px] shrink-0" />
                        <span className="text-theme-text-primary text-xs font-medium font-raleway truncate">{vendor.ownerName}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <FaPhone className="text-theme-text-tertiary text-[10px] shrink-0" />
                        <span className="text-theme-text-primary text-xs font-medium font-raleway truncate">{vendor.ownerPhone}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0 ml-auto sm:ml-0">
                      ...
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center bg-red-50 border border-red-100 text-red-500 hover:bg-red-600 hover:text-white rounded-lg transition-all duration-200 shrink-0"
                      >
