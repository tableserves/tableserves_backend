...
class DevelopmentTools {
  ...
  generateSampleData() {
    if (!this.isEnabled || !isFeatureEnabled('debug.enableMockData')) {
      logger.warn('Sample data generation not enabled', {}, 'DevelopmentTools');
      return false;
    }
    ...
    try {
      ...
      const sampleRestaurants = [
        {
          ...
          ownerEmail: 'john@bellavista.com',
        ...
        },
        {
          ...
          address: '456 Beach Ave, City, State 12345',
          cuisine: 'Seafood',
          status: 'active'
        }
      ];
      ...
      const sampleZones = [
        {
          ...
          ownerEmail: 'mike@downtown.com',
          ownerPhone: '+1234567892',
          address: '789 Downtown Blvd, City, State 12345',
          city: 'Metro City',
          status: 'active'
        }
      ];
      ...
      sampleRestaurants.forEach(restaurant => {
        dataAccessLayer.addRestaurant(restaurant);
      });

      // Add zones
      sampleZones.forEach(zone => {
        dataAccessLayer.addZone(zone);
      });

      logger.info('Sample data generated', {
        restaurants: sampleRestaurants.length,
      ...
      logger.error('Failed to generate sample data', error, 'DevelopmentTools');
      return false;
    }
  }
