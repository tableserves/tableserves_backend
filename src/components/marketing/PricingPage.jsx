    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-5">
          <div>
            <h3 className={`font-bold text-lg ${isPopular ? 'text-orange-700' : 'text-gray-900'}`}>
              {plan.label}
            </h3>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <ul className="space-y-2">
            <li className="flex items-center">
              ...
              <span className={plan.features?.crudMenu ? 'text-gray-700' : 'text-gray-500'}>
                Menu Management
              </span>
            </li>
            <li className="flex items-center">
              ...
              <span className={plan.features?.branding ? 'text-gray-700' : 'text-gray-500'}>
                QR Customization
              </span>
            </li>
            <li className="flex items-center">
              ...
              <span className={plan.features?.analytics ? 'text-gray-700' : 'text-gray-500'}>
                Advanced Analytics
              </span>
            </li>
            <li className="flex items-center">
              ...
              <span className={plan.features?.modifiers ? 'text-gray-700' : 'text-gray-500'}>
                Menu Modifiers
              </span>
            </li>
            <li className="flex items-center">
              ...
              <span className={plan.features?.prioritySupport ? 'text-gray-700' : 'text-gray-500'}>
                Priority Support
              </span>
            </li>
            <li className="flex items-center">
              ...
              <span className={plan.features?.watermark ? 'text-gray-500' : 'text-gray-700'}>
                TableServe Watermark
              </span>
            </li>
          </ul>
        </div>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Start free and upgrade as your hotel or restaurant grows.
            </p>
          </div>
                  ...
                  <div className="bg-white border-2 border-purple-200 rounded-2xl p-8 max-w-sm">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-4 text-purple-700 bg-purple-50 p-4 rounded-xl border border-purple-100">
                        ...
                        <div>
                          <div className="font-bold text-lg">admin@tableserve.com</div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-gray-600">
                ...
                <div className="flex items-center">
                  ...
                  <span>admin@tableserve.com</span>
                </div>
              </div>
            </div>
          </div>
