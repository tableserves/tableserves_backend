/**
 * Socket Event Constants - Frontend
 * Mirror of backend socket events for type safety
 * 
 * RULES:
 * 1. Must match backend/src/constants/socketEvents.js exactly
 * 2. Use snake_case for all event names
 * 3. Never hardcode event names - always import from this file
 */
