...
export const generateRestaurantUrl = (restaurantId, tableId, userId, path = '') => {
    ...
    if (normalizedUserId) {
        return `/restaurant/${restaurantId}/table/${tableId}/user/${normalizedUserId}${pathSegment}`;
    }
    
    return `/restaurant/${restaurantId}/table/${tableId}${pathSegment}`;
};
...
export const generateZoneUrl = (zoneId, tableId, userId, path = '') => {
    ...
    if (normalizedUserId) {
        return `/zone/${zoneId}/table/${tableId}/user/${normalizedUserId}${pathSegment}`;
    }
    
    return `/zone/${zoneId}/table/${tableId}${pathSegment}`;
};
...
export const generateShopUrl = (zoneId, tableId, userId, shopId, path = '') => {
    ...
    if (normalizedUserId) {
        return `/zone/${zoneId}/table/${tableId}/user/${normalizedUserId}/shop/${shopId}${pathSegment}`;
    }
    
    return `/zone/${zoneId}/table/${tableId}/shop/${shopId}${pathSegment}`;
};
